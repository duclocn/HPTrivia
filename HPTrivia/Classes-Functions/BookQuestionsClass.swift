...
class BookQuestions {
    ...
    private func populateBooks(with organizedQuestions: [[QuestionModel]]) {
        ...
        books.append(BookModel(id: 3, image: "hp3", questions: organizedQuestions[1], status: .inactive))
        books.append(BookModel(id: 4, image: "hp4", questions: organizedQuestions[1], status: .locked))
        books.append(BookModel(id: 5, image: "hp5", questions: organizedQuestions[1], status: .locked))
        books.append(BookModel(id: 6, image: "hp6", questions: organizedQuestions[1], status: .locked))
        books.append(BookModel(id: 7, image: "hp7", questions: organizedQuestions[1], status: .locked))
    }
}
